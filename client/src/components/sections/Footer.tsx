  ...
  return (
    ...
    >
      ...
      <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "6rem", paddingBottom: "6rem" }}>
        <div style={{ marginLeft: "auto", maxWidth: "480px" }}>
          ...
          <div id="footer-cta-row" className="reveal reveal-delay-3" style={{ display: "flex", gap: "1rem", flexWrap: "wrap", marginBottom: "4rem" }}>
            <a href="https://continuary.soulengineer.online/apply" className="btn-amber" style={{ fontSize: "1rem", padding: "0.875rem 2rem" }}>
              Apply for a slot
            </a>
      ...
      <div style={{
        ...
        <a href="https://continuary.soulengineer.online/apply" className="btn-amber" style={{ width: "100%", textAlign: "center", display: "block" }}>
